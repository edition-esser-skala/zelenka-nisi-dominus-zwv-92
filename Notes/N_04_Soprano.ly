...
NisiDominusSopranoNotes = {
	\relative c' {
		...
		d r4
		R2.*10 %112
		r4 r8 \mvTr fis?8\fE^\tuttiE dis fis
		h,4 h8 h g h
		g4 e8 e' h e %115
		e4 dis8 dis fis dis
		a4 a8 dis fis? dis
...
NisiDominusSopranoLyrics = \lyricmode {
	...
	Non con -- fun -- %113
	de -- tur, non con -- fun --
	de -- tur, non con -- fun -- %115
	de -- tur, non con -- fun --
	de -- tur, non con -- fun --
	de -- tur, non con -- fun --
	de -- tur, non con -- fun --
	de -- tur, non con -- fun -- %120
	de -- tur, non con -- fun --
	de -- tur, non con -- fun --
	de -- tur
	cum lo -- que -- tur
